...
<a href="https://play.google.com/store/apps/details?id=com.vpn1.app">
...
- geoip.dat and geosite.dat files are in `Android/data/com.vpn1.app/files/assets` (path may differ on some Android device)
