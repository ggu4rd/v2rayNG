...
import com.vpn1.app.AppConfig.DEFAULT_NETWORK
import com.vpn1.app.AppConfig.DNS_ALIDNS_ADDRESSES
import com.vpn1.app.AppConfig.DNS_ALIDNS_DOMAIN
import com.vpn1.app.AppConfig.DNS_CLOUDFLARE_ADDRESSES
import com.vpn1.app.AppConfig.DNS_CLOUDFLARE_DOMAIN
import com.vpn1.app.AppConfig.DNS_DNSPOD_ADDRESSES
import com.vpn1.app.AppConfig.DNS_DNSPOD_DOMAIN
import com.vpn1.app.AppConfig.DNS_GOOGLE_ADDRESSES
import com.vpn1.app.AppConfig.DNS_GOOGLE_DOMAIN
import com.vpn1.app.AppConfig.DNS_QUAD9_ADDRESSES
import com.vpn1.app.AppConfig.DNS_QUAD9_DOMAIN
import com.vpn1.app.AppConfig.DNS_YANDEX_ADDRESSES
import com.vpn1.app.AppConfig.DNS_YANDEX_DOMAIN
import com.vpn1.app.AppConfig.GEOIP_CN
import com.vpn1.app.AppConfig.GEOSITE_CN
import com.vpn1.app.AppConfig.GEOSITE_PRIVATE
import com.vpn1.app.AppConfig.GOOGLEAPIS_CN_DOMAIN
import com.vpn1.app.AppConfig.GOOGLEAPIS_COM_DOMAIN
import com.vpn1.app.AppConfig.HEADER_TYPE_HTTP
import com.vpn1.app.AppConfig.LOOPBACK
import com.vpn1.app.AppConfig.PROTOCOL_FREEDOM
import com.vpn1.app.AppConfig.TAG_BLOCKED
import com.vpn1.app.AppConfig.TAG_DIRECT
import com.vpn1.app.AppConfig.TAG_FRAGMENT
import com.vpn1.app.AppConfig.TAG_PROXY
import com.vpn1.app.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.vpn1.app.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import com.vpn1.app.dto.ConfigResult
...
import com.vpn1.app.dto.V2rayConfig.RoutingBean.RulesBean
import com.vpn1.app.extension.isNotNullEmpty
import com.vpn1.app.fmt.HttpFmt
import com.vpn1.app.fmt.Hysteria2Fmt
import com.vpn1.app.fmt.ShadowsocksFmt
import com.vpn1.app.fmt.SocksFmt
import com.vpn1.app.fmt.TrojanFmt
import com.vpn1.app.fmt.VlessFmt
import com.vpn1.app.fmt.VmessFmt
import com.vpn1.app.fmt.WireguardFmt
