...
abstract class ResolvedPlugin(protected val resolveInfo: ResolveInfo) : Plugin() {
    ...
    override val label: CharSequence get() = resolveInfo.loadLabel(MainApplication.application.packageManager)
    override val icon: Drawable get() = resolveInfo.loadIcon(MainApplication.application.packageManager)
    ...
    fun getPackageInfo(packageName: String) = MainApplication.application.packageManager.getPackageInfo(
